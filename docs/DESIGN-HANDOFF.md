# d35213d9-b80c-4b99-b4c8-3fcc44753ae8 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `neoeffex-landing-page.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `neoeffex-landing-page.html`
...
- A single self-contained `neoeffex-landing-page.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `neoeffex-landing-page.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `brand-spec.md`
- `sketch-2026-08-28T19-19-46.sketch.json`

## Coding checklist for AI tools
1. Inspect `neoeffex-landing-page.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
