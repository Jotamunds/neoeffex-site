# modelos implementation handoff

This archive is the source of truth for turning the design into production code. Start from `clinica-odontologica-premium/index.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `clinica-odontologica-premium/index.html`
...
- A single self-contained `clinica-odontologica-premium/index.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `clinica-odontologica-premium/index.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `clinica-odontologica-premium/index.html`

## Styles
- `clinica-odontologica-premium/assets/css/style.css`

## Scripts/components
- `clinica-odontologica-premium/assets/js/main.js`

## Assets and supporting files
- `clinica-odontologica-premium/assets/img/alinhador.jpg`
- `clinica-odontologica-premium/assets/img/cadeira-dental.jpg`
- `clinica-odontologica-premium/assets/img/consulta-dental.jpg`
- `clinica-odontologica-premium/assets/img/consultorio.jpg`
- `clinica-odontologica-premium/assets/img/sorriso-editorial.jpg`
- `clinica-odontologica-premium/assets/img/sorriso-estetica.jpg`
- `clinica-odontologica-premium/assets/img/sorriso-natural.jpg`
- `clinica-odontologica-premium/assets/img/sorriso.jpg`
- `clinica-odontologica-premium/brand-spec.md`
- `clinica-odontologica-premium/landing-review.png`
- `clinica-odontologica-premium/photo-review.png`
- `clinica-odontologica-premium/README.md`

## Coding checklist for AI tools
1. Inspect `clinica-odontologica-premium/index.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
